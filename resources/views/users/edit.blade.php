                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.update', ['user' => $user]) }}" novalidate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="employee_id" type="employee_id" class="form-control @error('employee_id') is-invalid @enderror" name="employee_id" value="{{ $user->employee_id }}" required autocomplete="employee_id">
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        @foreach ($roles as $role)
                                            <option @if($user->role === $role->name) selected="selected" @endif value="{{ mb_strtolower($role->name, 'UTF-8') }}">{{ ucwords(__($role->name)) }}</option>
                                        @endforeach
                                    </select>
